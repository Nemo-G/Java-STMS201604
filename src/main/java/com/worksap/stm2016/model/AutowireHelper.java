 ...
 * MUST BE REGISTERED IN Config File
 */
public final class AutowireHelper implements ApplicationContextAware {
     ...
     * if one of the specified beans which need to be autowired
     * are null.
     *
     * @param classToAutowire the instance of the class which holds @Autowire annotations
     * @param beansToAutowireInClass the beans 
     * which have the @Autowire annotation in the specified {#classToAutowire}
     */
